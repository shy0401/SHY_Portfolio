...
/media/awards/ai-contest-certificate.jpg|AI-based Image Generation Contest Certificate|Merged record with the AI Image Contest 3rd-place result
/media/awards/ai-image-3rd.png|AI Image Contest 3rd Place|Competition result image
/media/awards/gyeryong-reading-contest-excellence.png|Reading Contest Excellence Award|Gyeryongdae Service Support Group award proof
{{< /portfolio_slider >}}

## Activities and Next Steps

- Sejong HackTheon participation planned
- Connect security challenge writeups with project documentation
- Reframe competition outcomes into cyber-investigation-oriented analysis records
- The Army Cyber Operations Center cyber monitoring soldier career certificate is reflected as a career record; a proof file can be linked once available

## Next Plan

- Maintain writeups in the order of `hypothesis → reproduction → evidence → response perspective`
